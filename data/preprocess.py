...
def process_post(raw_file_path,processed_file_path = "data/processed_posts.json"):
    with open(raw_file_path,encoding='utf-8',error='ignore') as file:
         enriched_post = []
...
def get_unified_tags(post_with_metadata):
    ...
    chain = pt | llm
    response = chain.invoke(input={'tags':str(unique_tags)})
    try:
...
def extract_metadata(post):
    ...
    5. Return result only in JSON object nothing more than or less than that.
...
if __name__ == "__main__":
     process_post("C:/Users/nehap/Downloads/Linkedin_Post_Generator/data/raw_post.json","C:/Users/nehap/Downloads/Linkedin_Post_Generator/data/processed_posts.json")
